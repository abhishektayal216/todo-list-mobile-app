...
function App() {
  ...
  if (!hasOnboarded) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-100 p-4">
        <div className="w-full max-w-[390px] bg-white rounded-3xl overflow-hidden shadow-xl">
          <div className="relative h-72 bg-[#3B82F6] overflow-hidden">
  ...
  if (view === 'search') {
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-100 p-4">
        <div className="w-full max-w-[390px] bg-white rounded-3xl overflow-hidden shadow-xl min-h-[700px] flex flex-col">
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-100 p-4">
      <div className="w-full max-w-[390px] bg-white rounded-3xl overflow-hidden shadow-xl relative min-h-[720px] flex flex-col">
        {/* Top icons */}
